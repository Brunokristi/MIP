...
\begin{figure*}[tbh]
\centering
\includegraphics[scale=1.0]{Untitled Diagram.drawio.png}
...
Niekedy je potrebné nadpisom označiť odsek.xhfxhfxgf hhchfcfhcfgchfc Text pokračuje hneď za nadpisom.
